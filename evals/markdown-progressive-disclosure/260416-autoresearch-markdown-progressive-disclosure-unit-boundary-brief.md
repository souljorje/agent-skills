...
- `playbooks/incident-guide.md`
  ...
  - This is a separate unit entrypoint and is not part of the refunds unit.
- `playbooks/README.md`
  - 12 short lines of directory overview notes
  - This is nearby repo documentation, not part of the refunds unit by default.
- `playbooks/scratch-notes.md`
...
- When asked whether `README.md` belongs to the same unit: no.
...
- `playbooks/incident-guide.md` is not treated as a public child of `playbooks/refunds.md`.
- `playbooks/README.md` is not treated as a public child of `playbooks/refunds.md`.
