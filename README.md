...
| --- | --- | --- |
| agentic-markdown | 9.5 | Use when restructuring agent-readable Markdown into deterministic context trees with required frontmatter, explicit `Source:` child links, context links, reuse-first updates, and lazy traversal. |
